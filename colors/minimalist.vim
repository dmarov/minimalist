...
hi Cursor           ctermfg=234     ctermbg=255     cterm=NONE      guifg=#1C1C1C       guibg=#B3B3B3   gui=NONE
...
hi DiffAdd          ctermfg=255     ctermbg=64      cterm=bold      guifg=#B3B3B3       guibg=#5F8700   gui=bold
...
hi DiffText         ctermfg=255     ctermbg=24      cterm=bold      guifg=#B3B3B3       guibg=#005F87   gui=bold
hi Directory        ctermfg=179     ctermbg=NONE    cterm=NONE      guifg=#D7AF5F       guibg=NONE      gui=NONE
hi ErrorMsg         ctermfg=255     ctermbg=167     cterm=NONE      guifg=#B3B3B3       guibg=#D75F5F   gui=NONE
...
hi Normal           ctermfg=255     ctermbg=234     cterm=NONE      guifg=#B3B3B3       guibg=#1C1C1C   gui=NONE
...
hi StatusLine       ctermfg=255     ctermbg=239     cterm=bold      guifg=#B3B3B3       guibg=#4E4E4E   gui=bold
hi StatusLineNC     ctermfg=255     ctermbg=239     cterm=NONE      guifg=#B3B3B3       guibg=#4E4E4E   gui=NONE
hi Title            ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi WarningMsg       ctermfg=255     ctermbg=167     cterm=NONE      guifg=#B3B3B3       guibg=#D75F5F   gui=NONE
...
hi NERDTreeFile     ctermfg=241     ctermbg=NONE    cterm=NONE      guifg=#D3D3D3       guibg=NONE      gui=NONE
...
hi Error            ctermfg=255     ctermbg=167     cterm=NONE      guifg=#B3B3B3       guibg=#D75F5F   gui=NONE
...
hi Identifier       ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=italic
...
hi SpellBad         ctermfg=255     ctermbg=167     cterm=NONE      guifg=#B3B3B3       guibg=#D75F5F   gui=undercurl
hi SpellCap         ctermfg=255     ctermbg=74      cterm=NONE      guifg=#B3B3B3       guibg=#5FAFD7   gui=undercurl
hi SpellRare        ctermfg=255     ctermbg=140     cterm=NONE      guifg=#B3B3B3       guibg=#AF87D7   gui=undercurl
hi SpellLocal       ctermfg=255     ctermbg=14      cterm=NONE      guifg=#B3B3B3       guibg=#5FB3B3   gui=undercurl
...
hi cssAttrComma         ctermfg=231     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi cssURL               ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=italic
...
hi javaScriptGlobal     ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi javaScriptMessage    ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi phpIdentifier        ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi phpMethodsVar        ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi phpSuperglobals      ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi sassFunction         ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
...
hi shVariable           ctermfg=255     ctermbg=NONE    cterm=NONE      guifg=#B3B3B3       guibg=NONE      gui=NONE
